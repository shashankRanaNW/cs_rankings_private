...
with open('./CORE.csv', 'r') as csv_file:
    ...
    for row in csv_reader:
        ...
        if row[4] == 'A*':
            ...
            a_star_list.append( {Area(row[2].lower()) : Conference(row[1].split(',')[0].split(';')[0].split('.')[0].split('/')[0].rstrip())} )
            # a_star_list_full.append([row[1].split(',')[0].split(';')[0].split('.')[0].split('/')[0].rstrip(),row[2].split(',')[0].split(';')[0].split('.')[0].split('/')[0].rstrip()])
        elif row[4] == 'A':
            # Append 2nd and 3rd columns to the A list
            a_list.append({Area(row[2].lower()) : Conference(row[1].split(',')[0].split(';')[0].split('.')[0].split('/')[0].rstrip())} )
            a_list_full.append([row[1].split(',')[0].split(';')[0].split('.')[0].split('/')[0].rstrip(),row[2].split(',')[0].split(';')[0].split('.')[0].split('/')[0].rstrip()])
        elif row[4] == 'B':
            # Append 2nd and 3rd columns to the B list
            b_list.append( {Area(row[2].lower()) : Conference(row[1].split(',')[0].split(';')[0].split('.')[0].split('/')[0].rstrip())} )
            b_list_full.append([row[1].split(',')[0].split(';')[0].split('.')[0].split('/')[0].rstrip(),row[2].split(',')[0].split(';')[0].split('.')[0].split('/')[0].rstrip()])
        elif row[4] == 'C':
            c_list.append( {Area(row[2].lower()) : Conference(row[1].split(',')[0].split(';')[0].split('.')[0].split('/')[0].rstrip())}  )
            c_list_full.append([row[1].split(',')[0].split(';')[0].split('.')[0].split('/')[0].rstrip(),row[2].split(',')[0].split(';')[0].split('.')[0].split('/')[0].rstrip()])
            
        elif row[4] == 'D':
            d_list.append( {Area(row[2]) : Conference(row[1].split(',')[0].split(';')[0].split('.')[0].split('/')[0].rstrip())}  )
            d_list_full.append([row[1].split(',')[0].split(';')[0].split('.')[0].split('/')[0].rstrip(),row[2].split(',')[0].split(';')[0].split('.')[0].split('/')[0].rstrip()])
